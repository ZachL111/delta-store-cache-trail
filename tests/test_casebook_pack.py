"""Regression checks for the delta-store-cache-trail casebook."""
...
from casebook.harness import assert_expected, delta_store_cache_trail_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(delta_store_cache_trail_summary(), assert_expected())
